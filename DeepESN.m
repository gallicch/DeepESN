classdef DeepESN < handle
    ...
    %
    %
    %This class is part of the DeepESN18a Toolbox, November 2018
    %Claudio Gallicchio
    ...
    properties
        ...
        run_states %Nr x Nt reservoir activation matrix corresponding to the last reservoir run (Nt is the number of timesteps)
    ...
    methods (Access = public)
        ...
        % self.washout timesteps (otherwise set it to 0). In practice, set this value to 1 when
